...
extends FCommand {
    public CmdClaim() {
        ...
        this.requirements = new CommandRequirements.Builder(Permission.CLAIM).playerOnly().build();
    }
    ...
    public void perform(final CommandContext commandContext) {
        ...
        if (n < 2) {
            ...
            new SpiralTask(this, new FLocation(commandContext.player), n){
                ...
                @Override
                public boolean work() {
                    boolean bl = commandContext.fPlayer.attemptClaim(faction, this.currentLocation(), true);
                    if (bl) {
                        this.failCount = 0;
