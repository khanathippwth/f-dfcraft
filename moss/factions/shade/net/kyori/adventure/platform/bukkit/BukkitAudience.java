...
import moss.factions.shade.net.kyori.adventure.platform.facet.FacetAudience;
import moss.factions.shade.net.kyori.adventure.platform.facet.FacetAudienceProvider;
import moss.factions.shade.net.kyori.adventure.platform.viaversion.ViaFacet;
...
extends FacetAudience<CommandSender> {
    ...
    BukkitAudience(@NotNull Plugin plugin, FacetAudienceProvider<?, ?> facetAudienceProvider, @NotNull Collection<CommandSender> collection) {
