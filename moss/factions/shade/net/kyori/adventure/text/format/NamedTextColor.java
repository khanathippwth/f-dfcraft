...
implements TextColor {
    ...
    public static final Index<String, NamedTextColor> NAMES = Index.create(namedTextColor -> namedTextColor.name, VALUES);
    ...
    public static NamedTextColor nearestTo(@NotNull TextColor textColor) {
        ...
        return TextColor.nearestColorTo(VALUES, textColor);
    }
