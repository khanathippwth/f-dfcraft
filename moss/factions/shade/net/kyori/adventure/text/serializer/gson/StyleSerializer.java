...
extends TypeAdapter<Style> {
    ...
    public Style read(JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (string.equals(COLOR)) {
                ...
                if (object3.color != null) {
                    builder.color(object3.color);
                    continue;
                }
                if (object3.decoration == null) continue;
                builder.decoration(object3.decoration, TextDecoration.State.TRUE);
                continue;
            }
            ...
            if (string.equals(HOVER_EVENT)) {
                ...
                if (object3.has(HOVER_EVENT_CONTENTS)) {
                    jsonElement = object3.get(HOVER_EVENT_CONTENTS);
                    ...
                    jsonElement = object3.get("value");
                    if (StyleSerializer.isNullOrEmpty(jsonElement)) {
                        object4 = null;
                    } else {
                        object5 = (Component)this.gson.fromJson(jsonElement, SerializerFactory.COMPONENT_TYPE);
    ...
    private boolean readBoolean(JsonReader jsonReader) {
        ...
        throw new JsonParseException("Token of type " + jsonToken + " cannot be interpreted as a boolean");
    }
